...
namespace LibraryKadr
{
    ...
    public class ColumnWidthSaver
    {
        ...
        static string pathToProgramFiles = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData);
        ...
        static ColumnWidthSaver()
        {
            ...
            else
            {
                ...
                { 
                    File.Copy(pathToProgramFiles + @"\WidthOfColumnNew.bin", pathToProgramFiles + @"\WidthOfColumnNew.bin");
                }
                if (File.Exists(pathToProgramFiles + @"\WidthOfColumnNew.bin"))
                {
                    try
