/***********************************************************/
/**********   Generated at 19.01.2017 14:17:56     ********/
/*********************************************************/
using System;
...
namespace EntityGenerator
{
    ...
    public partial class EmpStaff : RowEntityBase
    {
        ...
        [Column(Name="EMP_STAFF_GROUP_ID", CanBeNull=false)]
        public Decimal? EmpStaffGroupID 
        {
            get
            {
                return this.GetDataRowField<Decimal?>(() => EmpStaffGroupID);
            }
            set
            {
                UpdateDataRow<Decimal?>(() => EmpStaffGroupID, value);
            }
        }
                #endregion
