...
namespace Kadr
{
    public partial class TransferToFR : Form
    {
        ...
        public TransferToFR(EMP_seq _emp, TRANSFER_seq _transfer, TRANSFER_seq _transferPrev,
            ...
            ListEmp _listEmp, bool flagArchive)
        {
            InitializeComponent();
            emp = _emp;
            transfer = _transfer;
            ...
            cbSubdiv_Name.AddBindingSource(transfer, SUBDIV_seq.ColumnsName.SUBDIV_ID, new LinkArgument(AppDataSet.subdiv, SUBDIV_seq.ColumnsName.SUBDIV_NAME));
            ...
            cbPos_Name.AddBindingSource(transfer, POSITION_seq.ColumnsName.POS_ID, new LinkArgument(AppDataSet.position, POSITION_seq.ColumnsName.POS_NAME));
        ...
        private void btPreview_Click(object sender, EventArgs e)
        {
            if (!flagDismiss)
            {
                ...
                subdivPrev = AppDataSet.subdiv.Where(i => i.SUBDIV_ID == r_transferPrev.SUBDIV_ID).FirstOrDefault().CODE_SUBDIV;
                posPrev = AppDataSet.position.Where(i => i.POS_ID == r_transferPrev.POS_ID).FirstOrDefault().CODE_POS;
                ...
                pos_namePrev = AppDataSet.position.Where(i => i.POS_ID == r_transferPrev.POS_ID).FirstOrDefault().POS_NAME;
