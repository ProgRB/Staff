...
namespace KadrWPF.Helpers
{
    class AppCommands
    {
        ...
        static AppCommands()
        {
            ...
            AddEmpStaff = new RoutedUICommand("Добавить фактического работника", "EditEmpStaff", typeof(AppCommands));
            EditEmpStaff = new RoutedUICommand("Редактировать фактического работника", "EditEmpStaff", typeof(AppCommands));
            DeleteEmpStaff = new RoutedUICommand("Удалить фактического работника", "EditEmpStaff", typeof(AppCommands));
