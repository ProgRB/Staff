...
type_transfer_id                           
from {0}.emp em, {0}.transfer tr1, {0}.subdiv sub, {0}.per_data 
where EM.PER_NUM = tr1.per_num and TR1.SUBDIV_ID = sub.subdiv_id and per_data.insurance_num is null and EM.PER_NUM = per_data.per_num
