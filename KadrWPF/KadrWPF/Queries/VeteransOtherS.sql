...
pos.pos_id=tr.pos_id and substr(pos.code_pos,1,1) not in (3,2) and R.REWARD_NAME_ID in (select RN.REWARD_NAME_ID from {1}.REWARD_NAME RN
...
where degree_id=04 and sub.code_subdiv=lpad('{0}',3,'0') and tr.subdiv_id=sub.subdiv_id and r.per_num=TR.PER_NUM and 
pos.pos_id=tr.pos_id and substr(pos.code_pos,1,1) not in (3,2) and emp.per_num=tr.per_num and upper(emp.emp_sex)='∆' and 
