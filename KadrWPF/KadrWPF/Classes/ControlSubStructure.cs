    ...
    public static class ControlAccess
    {
        ...
        private static void EnableByRule(System.Windows.Forms.Control control,HashSet<string> namesOfControls)
        {
            if (control != null)
            {
                ...
                if (control is System.Windows.Forms.Panel || control is GroupBox || control.Name == string.Empty || control is System.Windows.Forms.TabPage || control is System.Windows.Forms.Label || control is Form ||
