...
namespace Kadr
{
    public partial class HandBook : System.Windows.Forms.UserControl
    {
        ...
        public HandBook(Type _type_seq)
        {        
            InitializeComponent();
            type_seq = _type_seq;
        ...
        public HandBook(Type _type_seq, int _widthform, int _widthcolumn, params string[] _names)
        {
            InitializeComponent(); 
            type_seq = _type_seq;
