...
namespace KadrWPF
{
    //Сделаем класс в котором скажем какое значение правда а какое ложь
    ...
    /// <summary>
    /// Теперь опишем конвертер для Визибилити,  - значения можно поменять местами и получится Invert конвертер
    /// </summary>
