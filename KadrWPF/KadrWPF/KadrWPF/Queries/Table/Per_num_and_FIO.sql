WITH TRANS as 
    ...
    EGWORK as (
    select T.PER_NUM, TRANSFER_ID, WORKER_ID, TRUNC(EGW.GR_WORK_DATE_BEGIN) GR_WORK_DATE_BEGIN, 
...
where 
    ...
    not exists(select null from EGWORK EGW1 
        where EGW1.PER_NUM = E1.PER_NUM and EGW1.WORKER_ID = E1.WORKER_ID and EGW1.SIGN_SHORT_GR = 1 
