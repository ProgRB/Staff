...
namespace Kadr
{
    public partial class LoadEmp : Form
    {
        ...
        bool flagArchive;
        public LoadEmp(bool _flagArchive)
        {
            InitializeComponent();
        ...
        private void btFind_Click(object sender, EventArgs e)
        {
            ...
            if (flagArchive)
            {
                //sql = string.Format(Queries.GetQuery("SelectFindArchive.sql"), Connect.Schema, str_find.ToString() + sort);
                sql = string.Format(Queries.GetQuery("SelectListEmpArchive.sql"), 
                    Connect.Schema, str_find.ToString() + sort);
            }
            else
            {
                //sql = string.Format(Queries.GetQuery("SelectFind.sql"), Connect.Schema, str_find.ToString() + sort);
