...
namespace EntityGenerator
{
    ...
    public partial class EmpTransferData
    {
        /// <summary>
        ...
        public string ShortFIO
        {
            get
            {
                return $"{EmpLastName} {EmpFirstName.Substring(0, 1)}.{EmpMiddleName.Substring(0, 1)}.";
            }
        }
    }

    public partial class ProfStandart
    {
        /// <summary>
        /// Код и имя стандарта
        /// </summary>
        public string CodeNameStandart
        {
            get
            {
                return CodeProf + " " + ProfStandartName;
            }
        }
    }
