select EXTRACT(MONTH FROM ST.START_PERIOD) NUM_MONTH, D.CODE_DEGREE, DA.DEG_NOTE, DA.DEG_PRIORITY, DA.DEG_NUM_GROUP, DA.DEG_LEVEL, SIGN_INDUST_PERS,
...
GROUP BY D.CODE_DEGREE, DA.DEG_NOTE, DA.DEG_PRIORITY, EXTRACT(MONTH FROM ST.START_PERIOD), DA.DEG_NUM_GROUP, DA.DEG_LEVEL, SIGN_INDUST_PERS
ORDER BY NUM_MONTH,DEG_PRIORITY 