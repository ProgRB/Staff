...
{
    public partial class EmpSubLocation : Form
    {
        DataSet ds;
        ...
        public EmpSubLocation()
        {
            ...
            FilterVS.FilterChanged += new EventHandler(subdivSelector1_SubdivChanged);
            tsdpCurDate.Value = DateTime.Today;
            tsdpCurDate.ValueChanged += new EventHandler(tsdpCurDate_ValueChanged);
            UpdateRegions(FilterVS.subdiv_id);
            ...
            UpdateEmps(FilterVS.subdiv_id, tsdpCurDate.Value);
        ...
        private void dgEmps_SelectionChanged(object sender, EventArgs e)
        {
            ...
            UpdateEmpRegions(sel_tr, FilterVS.subdiv_id);
        }
