...
namespace Kadr
{
    public partial class HBType_Permit : Form
    {
        FormMain parentForm;
        TYPE_PERMIT_seq type_permit;        
        public HBType_Permit(FormMain _parentForm)
        {
            InitializeComponent();
        ...
        private void HBType_Permit_Activated(object sender, EventArgs e)
        {
            if (dgType_Permit.Rows.Count == 0)
            {
                this.btEditType_Permit.Enabled = false;
                this.btDeleteType_Permit.Enabled = false;
            }
        }
    }
}
