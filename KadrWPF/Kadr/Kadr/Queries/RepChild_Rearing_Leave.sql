...
select DISTINCT FIRST_VALUE(TP.CODE_SUBDIV) OVER(PARTITION BY WORKER_ID ORDER BY DATE_TRANSFER DESC) CODE_SUBDIV,
    ...
    CRL_DATE_BEGIN_1_5, CRL_DATE_END_1_5, CRL_DATE_BEGIN_3, CRL_DATE_END_3, NOTE
from 
(
    select PER_NUM, 1 RN, DATE_BEGIN_LEAVE DATE_BEGIN_LEAVE_1_5, 
        DECODE(NVL(CRL.BREAKPOINT_LEAVE,0),0,CRL.DATE_END_LEAVE,CRL.DATE_DEPARTURE-1) DATE_END_LEAVE_1_5, null CRL_DATE_BEGIN_3, 
