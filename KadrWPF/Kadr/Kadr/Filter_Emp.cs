...
namespace Kadr
{
    public partial class Filter_Emp : Form
    {
        ...
        public Filter_Emp()
        {
            ...
            {
                cbSubdiv_Name.AddBindingSource(SUBDIV_seq.ColumnsName.SUBDIV_ID.ToString(), new LinkArgument(FormMain.subdiv, SUBDIV_seq.ColumnsName.SUBDIV_NAME));
                cbSubdiv_Name.SelectedItem = null;
                cbPos_Name.AddBindingSource(POSITION_seq.ColumnsName.POS_ID.ToString(), new LinkArgument(FormMain.position, POSITION_seq.ColumnsName.POS_NAME));
