...
namespace Kadr
{
    public partial class AddFindEmp : Form
    {
        ...
        public AddFindEmp(FormMain _parentForm)
        {
            InitializeComponent();
        ...
        private void btNewEmp_Click(object sender, EventArgs e)
        {
            ...
            PersonalCard personalCard = new PersonalCard(per_num_book[0].PER_NUM.ToString(), 0, record_emp, true, true, true, 0, null);
        ...
        private void btPer_Num_Click(object sender, EventArgs e)
        {
            if (str_find != null)
            {
                if (dtEmp.Rows.Count != 0)
                {
                    ...
                    PersonalCard personalcard = new PersonalCard(per_num, 0, record_emp, false, true, false, 0, null);                    
