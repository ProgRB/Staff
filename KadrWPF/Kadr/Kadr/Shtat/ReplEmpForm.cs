    ...
    public partial class ReplEmpForm : Form
    {
        ...
        private void FillReplTable(DataGridView d,string transfe_id,decimal sign_combine,decimal whos_repl)
        {
            try
            {
                ...
                OracleDataAdapter a = new OracleDataAdapter(string.Format(Queries.GetQuery(@"new\FillReplEmp.sql"), DataSourceScheme.SchemeName), Connect.CurConnect);
        ...
        public ReplEmpForm(decimal? transfer_id, string SubRole =  null, bool show_add_combine = false)
        {
            ...
            OracleDataAdapter a = new OracleDataAdapter(string.Format(Queries.GetQuery(@"new\GetEmpData.sql"),DataSourceScheme.SchemeName),Connect.CurConnect);
            a.SelectCommand.BindByName = true;
