...
namespace Kadr.Shtat
{
    public partial class ReplEmpAdd : Form
    {
        ...
        {           
            ...
            OracleDataAdapter a = new OracleDataAdapter(string.Format(Queries.GetQuery(@"new\select_MAIN_and_REPL_data.sql"), DataSourceScheme.SchemeName), Connect.CurConnect);
