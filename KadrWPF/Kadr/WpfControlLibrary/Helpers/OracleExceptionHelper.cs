...
namespace Helpers
{
    ...
    {
        /// <summary>
        /// Возвращает форматированное сообщение для пользователя
        /// </summary>
        /// <param name="ex"></param>
        /// <returns></returns>
            ...
            if (ex is OracleException)
            {
                ...
                else
                {
                    ...
                    switch (orcl_ex.Number)
                    {
                        ...
                        case 942: return "Не найден объект в БД. Возможно недостаточно прав на выполнение операции.\n"+orcl_ex.Message;
                        case 1400: return "Невозможно установить пустое значение в поле \n" + orcl_ex.Message;
                    }
                    return ex.Message;
                }
            }
