...
(
    ...
    where TRANSFER_ID is not null and VI.DETENTION_DATE between :p_begin_date and :p_end_date 
        and :p_sign_report = 1
    union all
    select
    ...
    where PERCO_SYNC_ID is not null and VI.DETENTION_DATE between :p_begin_date and :p_end_date 
        and :p_sign_report = 2
    union all
    ...
    where OTHER_VIOLATOR_ID is not null and VI.DETENTION_DATE between :p_begin_date and :p_end_date 
        and :p_sign_report = 3
) V1