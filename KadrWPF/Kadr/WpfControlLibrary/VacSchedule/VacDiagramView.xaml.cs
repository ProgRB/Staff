...
namespace WpfControlLibrary.VacSchedule
{
    ...
    /// </summary>
    public partial class VacDiagramView : System.Windows.Controls.UserControl
    {
    ...
    public class VacDiagramFilterModel: NotificationObject
    {
        ...
        /// </summary>
        public IEnumerable<Model.Subdiv> SubdivSource
        {
            get
            {
                return ds.Tables["SUBDIV"].Rows.OfType<DataRow>()
                    .Select(r => new Model.Subdiv() { DataRow = r})
